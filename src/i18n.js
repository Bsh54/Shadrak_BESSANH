...
const resources = {
  en: {
    translation: {
      ...
      "achievements.sources": "Sources & Proof",
      ...
      "projects.nawiri.description": "A conversational AI assistant that helps West African families access the public aid they are legally entitled to. Describe your situation in plain words — in 5 languages including Fɔngbe, Wolof & Twi — and NAWIRI finds the programs you qualify for, the documents to bring and who to contact. Built with Next.js & Gemini.",
      "projects.neurobridge.description": "An AI communication aid for non-verbal and minimally-verbal autistic people. Tap a few pictograms and instantly hear a clear first-person sentence spoken out loud, while caregivers track patterns over time with an AI assistant. Accessibility-first. Built with Next.js, React 19 & Web Speech API.",
      "projects.cottonpay.description": "A digital identity & payment platform for cotton farmers — awarded 2nd place at the African Digital Identity Hackathon 2026 (ID4Africa). Gives unbanked farmers a verifiable identity and secure payments. Built with React & Web3.",
      "projects.neurosynthetix.description": "A multilingual voice assistant that connects patients to real recruiting clinical trials. It combines RAG search (DeepSeek), voice AI (Sarvam) and a Neo4j knowledge graph unifying trial registries. Built at HackHazards 26 with Python.",
      "projects.phytovance.description": "A virtual molecular docking platform focused on neglected African diseases, helping researchers screen plant-derived compounds against disease targets. Built with Python.",
      "projects.aegisflow.description": "A confidential AML compliance firewall for FXRP inflows on Flare, screening transactions for money-laundering risk without exposing sensitive data. Built at the Flare Summer Signal hackathon with TypeScript.",
      "projects.payvault.description": "Confidential payroll & treasury management running on Nox, letting companies pay salaries and manage funds privately on-chain. Built at the iExec WTF Hackathon with TypeScript.",
      "projects.sesion.description": "A Nimiq Pay Mini App to book fitness & wellness sessions and pay coaches directly in NIM — no middleman, instant settlement. Built with JavaScript & Nimiq Pay.",
      "projects.horus.description": "\"The eye on every match\" — a Telegram pundit bot for the 2026 World Cup delivering live notifications with market context, TTS voice notes and conversational AI over real-time on-chain data on Solana.",
      "projects.gatekeep.description": "A pay-to-reach toll for your inbox, settled on Monad. Strangers lock a refundable deposit to reach you — reply and they're refunded, mark spam and it funds public goods. Built with TypeScript.",
      ...
      "badge.iexec": "iExec Hackathon",
      "badge.nimiq": "Nimiq Hackathon",
      "badge.solana": "Solana Hackathon",
      "badge.monad": "Monad Hackathon",
  ...
  fr: {
    translation: {
      ...
      "achievements.sources": "Sources & Preuves",
      ...
      "projects.nawiri.description": "Un assistant IA conversationnel qui aide les familles d'Afrique de l'Ouest à accéder aux aides publiques auxquelles elles ont droit. Décrivez votre situation en langage naturel — en 5 langues dont le Fɔngbe, le Wolof et le Twi — et NAWIRI trouve les programmes éligibles, les documents à fournir et qui contacter. Développé avec Next.js & Gemini.",
      "projects.neurobridge.description": "Une aide à la communication par IA pour les personnes autistes non-verbales. Sélectionnez quelques pictogrammes et entendez aussitôt une phrase claire à la première personne, tandis que les aidants suivent les tendances dans le temps grâce à un assistant IA. Accessibilité avant tout. Développé avec Next.js, React 19 & Web Speech API.",
      "projects.cottonpay.description": "Une plateforme d'identité numérique et de paiement pour les producteurs de coton — 2e place au Hackathon African Digital Identity 2026 (ID4Africa). Offre aux agriculteurs non bancarisés une identité vérifiable et des paiements sécurisés. Développé avec React & Web3.",
      "projects.neurosynthetix.description": "Un assistant vocal multilingue qui met en relation les patients avec des essais cliniques réels en recrutement. Il combine recherche RAG (DeepSeek), IA vocale (Sarvam) et un graphe de connaissances Neo4j unifiant les registres d'essais. Réalisé au HackHazards 26 avec Python.",
      "projects.phytovance.description": "Une plateforme de docking moléculaire virtuel dédiée aux maladies africaines négligées, aidant les chercheurs à cribler des composés issus de plantes contre des cibles pathologiques. Développé avec Python.",
      "projects.aegisflow.description": "Un firewall de conformité AML confidentiel pour les flux FXRP sur Flare, qui évalue le risque de blanchiment sans exposer les données sensibles. Réalisé au hackathon Flare Summer Signal avec TypeScript.",
      "projects.payvault.description": "Gestion de paie et de trésorerie confidentielle sur Nox, permettant aux entreprises de verser les salaires et gérer leurs fonds de façon privée on-chain. Réalisé au iExec WTF Hackathon avec TypeScript.",
      "projects.sesion.description": "Une Mini App Nimiq Pay pour réserver des séances de fitness et bien-être et payer les coachs directement en NIM — sans intermédiaire, règlement instantané. Développé avec JavaScript & Nimiq Pay.",
      "projects.horus.description": "« L'œil sur chaque match » — un bot Telegram pour la Coupe du Monde 2026 : notifications en direct avec contexte de marché, notes vocales TTS et IA conversationnelle sur des données on-chain en temps réel sur Solana.",
      "projects.gatekeep.description": "Un péage anti-spam pour votre boîte mail, réglé sur Monad. Les inconnus bloquent une caution remboursable pour vous joindre — répondez et ils sont remboursés, signalez un spam et cela finance des biens publics. Développé avec TypeScript.",
