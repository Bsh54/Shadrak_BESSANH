...
const resources = {
  en: {
    translation: {
      ...
      "home.about.intro": "I am Shadrak BESSANH, a second-year Computer Science student in Benin, passionate about technology and artificial intelligence. At 20 years old, I am dedicated to developing my technical skills and contributing to innovative projects that address the challenges of our time.",
      ...
      "home.about.tools": "My vision is to become a versatile professional capable of designing and developing",
      "home.about.tools.python": "innovative solutions",
      "home.about.tools.frameworks": "by combining",
      "home.about.tools.list": "technical rigor and creativity",
      "home.about.tools.and": "to solve concrete problems and improve people's lives.",
  ...
  fr: {
    translation: {
      ...
      "home.about.title.end": "",
      "home.about.intro": "Je suis Shadrak BESSANH, étudiant en deuxième année de Licence Informatique au Bénin, passionné par la technologie et l'intelligence artificielle. À 20 ans, je me consacre à développer mes compétences techniques et à contribuer à des projets innovants qui répondent aux défis de notre époque.",
      ...
      "home.about.tools": "Mon objectif est de devenir un professionnel polyvalent capable de concevoir et développer des",
      "home.about.tools.python": "solutions innovantes",
      "home.about.tools.frameworks": "en combinant",
      "home.about.tools.list": "rigueur technique et créativité",
      "home.about.tools.and": "pour résoudre des problèmes concrets et améliorer la vie des gens.",
      "home.about.tools.react": "React.js",
