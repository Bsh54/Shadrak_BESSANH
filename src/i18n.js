...
const resources = {
  en: {
    translation: {
      ...
      "projects.oreus.description": "AI-powered video subtitling platform: upload a video, the AI transcribes with Whisper, translates intelligently (DeepSeek + Google Translate), and burns subtitles directly into the video via FFmpeg. 6 subtitle styles (YouTube, MrBeast, TikTok/Neon, Highlight, Cinema, Pop), 100+ languages including 39 African languages (Wolof, Yoruba, Hausa, Fon, Amharic…). Deployed on Azure VM + Cloudflare with rate limiting, bot detection, and real-time analytics dashboard. Technologies: Python 3.11, Flask, faster-Whisper, DeepSeek API, FFmpeg, libass, SQLite, Vanilla JS, Gunicorn.",
  ...
  fr: {
    translation: {
      ...
      "projects.oreus.description": "Plateforme IA de sous-titrage automatique de vidéos : uploadez une vidéo, l'IA transcrit avec Whisper, traduit intelligemment (DeepSeek + Google Translate) et grave les sous-titres directement dans la vidéo via FFmpeg. 6 styles de sous-titres (YouTube, MrBeast, TikTok/Neon, Surlignage, Cinéma, Pop), 100+ langues dont 39 langues africaines (Wolof, Yoruba, Hausa, Fon, Amharique…). Déployé sur Azure VM + Cloudflare avec limitation de débit, détection de bots et dashboard analytique en temps réel. Technologies : Python 3.11, Flask, faster-Whisper, DeepSeek API, FFmpeg, libass, SQLite, Vanilla JS, Gunicorn.",
